...
The [Verify Beneficiary Account](/api-reference/#verify-beneficiary-account) API endpoint can be used to verify a beneficiaries bank account details, and in SEPA Euro market verify the name of the individual or company provided.
...
b. Before you send a payment to an existing beneficiary

c. Before you send a payment to a new beneficiary
...
| currency | Form Data | Yes | EUR | Three-letter currency code <br> Currency in which money will be sent to the beneficiary's bank account |
...
| --- |--- | --- | --- | ---|
| answer | FormData | enum | full_match | Indicator of whether the verification has resulted in a match. Possible values are 'full_match', 'close_match' or 'no_match' |
...
**Handling:** It’s a no match. Display a negative notice highlighting the error. The actual_name will not be provided in the response. Create a button to give the end-customer the choice to edit the account details or keep what they entered. <br><br>
...
<tr>
    ...
    <td>Warning</td>
    <td><img src="/images/account_verification/error.svg"> <b>Incorrect beneficiary name</b><br><br>
...
_Example 1 - Paying a new beneficiary_ <br><br>

<img src="/images/account_verification/VoP-eu-6.png" width=100%>
_Example 2 - Paying an existing beneficiary_
