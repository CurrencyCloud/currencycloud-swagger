...
| `hold_period` | string | Duration the quote is valid for. Must be pre-configured for your account and be provided using one of the supported units - seconds (s) or minutes (m), e.g. `3m` |
